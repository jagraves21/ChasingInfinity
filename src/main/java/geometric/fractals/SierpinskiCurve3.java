...
public class SierpinskiCurve3 extends AbstractGeometricFractal<SierpinskiCurve3> {
	...
	public SierpinskiCurve3() {
		this(getSuggestedIterations());
	}

	public SierpinskiCurve3(int iterations) {
		this(iterations, true);
	}

	public SierpinskiCurve3(boolean reset) {
		this(getSuggestedIterations(), true);
	}

	public SierpinskiCurve3(int iterations, boolean reset) {
